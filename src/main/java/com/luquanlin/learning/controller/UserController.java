...
public class UserController {
    ...
    @RequestMapping("/selectVagueAccountUser")
    @ResponseBody
    @ApiOperation(value = "根据帐号模糊查询", notes = "直接返回数据", httpMethod = "POST")
    public Map selectVagueAccountUser(String user_account) {
        Map result = new HashMap();
        List<HashMap> user = userService.selectVagueAccountUser(user_account);
    ...
    @ResponseBody
    @ApiOperation(value = "根据帐号查询", notes = "直接返回数据", httpMethod = "POST")
    public Map selectAccountUser(String user_account) {
        Map result = new HashMap();
        List<HashMap> user = userService.selectAccountUser(user_account);
        result.put("data", user);
        return result;
    }
}
